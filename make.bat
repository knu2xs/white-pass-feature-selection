...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=white-pass-feature-selection
SET SUPPORT_LIBRARY = white_pass_feature_selection
SET ENV_NAME=white-pass-feature-selection
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/white-pass-feature-selection*.tar.bz2
