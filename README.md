# white-pass-feature-selection

SelectKBest and any other ideas I get for feature selection workflow.
...
```
    ...
    ├── setup.py           <- Setup script for the library (white_pass_feature_selection)
    ...
    │   ├── white-pass-feature-selection.aprx <- ArcGIS Pro project.    
    │   └── white-pass-feature-selection.tbx  <- ArcGIS Pro toolbox associated with the project.
    ├── data
    ...
    └── src                <- Source code for use in this project - all scripts, modules and code.
        └── white_pass_feature_selection <- Library containing the bulk of code used in this 
                                                  project. 
```
